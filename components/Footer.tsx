      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className="px-4 py-2 w-full bg-white/10 border border-white/30 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
              />
              <button
                type="submit"
                className="bg-yellow-500 hover:bg-yellow-400 text-blue-900 px-4 py-2 rounded-r-lg transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a
              href="#"
              className="text-white/60 hover:text-yellow-500 text-sm transition-colors"
            >
              Privacy Policy
            </a>
            <a
